						...
						<sec:ifLoggedIn>
							<ul>
								<sec:ifAnyGranted roles="ROLE_ADMIN">	
									...
									<li class="controller"><g:link controller="employee" action='saturdayReport' params="[isAdmin:false,max:20,fromIndex:true]" style="text-decoration: none;"><g:message code="saturday.followup" default="Last Name" /></g:link></li>	
