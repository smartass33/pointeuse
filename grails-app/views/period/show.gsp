	...
	<body>
		...
		<div id="show-year" class="content scaffold-show" role="main">
			...
			<ol class="property-list year">		
				<g:if test="${periodInstance?.year}">
				<li class="fieldcontain">
					<span id="period-label" class="property-label"><g:message code="period.period.label" default="Period" /></span>				
					<span class="property-value" aria-labelledby="period-label">${periodInstance.year}/${periodInstance.year+1}</span>				
				</li>
				</g:if>			
				<g:if test="${periodInstance?.year}">
				<li class="fieldcontain">
					<span id="year-label" class="property-label"><g:message code="period.year.label" default="Year" /></span>				
					<span class="property-value" aria-labelledby="year-label"><g:fieldValue bean="${periodInstance}" field="year"/></span>				
				</li>
				</g:if>	
			</ol>
			<g:form>
