...
<html>
	...
	<body>
		<a href="#create-function" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-function" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:functionInstance, action:'save']" >
				<fieldset class="form">
