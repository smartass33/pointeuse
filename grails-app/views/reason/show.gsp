	...
	<body>
		...
		<div id="show-reason" class="content scaffold-show" role="main">
			...
			<ol class="property-list reason">
				...
				<g:if test="${reasonInstance?.name}">
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="reason.name.label" default="Reason Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${reasonInstance}" field="name"/></span>
