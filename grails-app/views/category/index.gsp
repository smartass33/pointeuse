		...
		<div id="list-category" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="creationDate" title="${message(code: 'category.creationDate.label', default: 'Creation Date')}" />
				...
				<g:each in="${categoryInstanceList}" status="i" var="categoryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${categoryInstance.creationDate.format('dd/MM/yyyy')}</td>
						<td>${categoryInstance.user.firstName} ${categoryInstance.user.lastName}</td>
